...
public class Calculator {
    ...
    private static final int B_WIDTH = 80; // Button width
    private static final int B_HEIGHT = 70; // Button height
    private static final int MARGIN_X = 20;
    private static final int MARGIN_Y = 60;

    private JFrame window; // Jframe window for calculator
    private JTextField inText; // Main display panel
	//All the button for calculator
    private JButton btnC, btnSquare, btnMod, btnDiv, btn7, btn8, btn9,
            btnMul, btn4, btn5, btn6, btnSub, btn1, btn2, btn3, btnAdd, btnPoint, btn0, btnEqual, btnRoot, btnPower, btnLog, btnSwitch;
    ...
    private Calculator() {
        ...
        window.setSize(JFRAME_WIDTH, JFRAME_HEIGHT); // Set the width and the Height of the window
        window.setLocationRelativeTo(null); // Move Window To Center

        // Button fonts set to be Times New Roman
        ...
        btnSwitch.setBounds(20, 20, 140, 30);
        btnSwitch.setText("More Function");
        btnSwitch.setBackground(Color.BLUE.darker());
        btnSwitch.setForeground(Color.WHITE);
        btnSwitch.setCursor(new Cursor(Cursor.HAND_CURSOR));
        btnSwitch.addActionListener(event -> onShowScientificMode());
        window.add(btnSwitch);
        ...
        btnC = new JButton("C");
        btnC.setBounds(x[0], y[1], B_WIDTH, B_HEIGHT);
		...
		//set the square button
        btnSquare = new JButton("x\u00B2");
        btnSquare.setBounds(x[1], y[1], B_WIDTH, B_HEIGHT);
        ...
        btnSquare.addActionListener(event -> {
			...
			int square = str_to_int * str_to_int;
			inText.setText("" + square);
        });
        window.add(btnSquare);

		//set modulus button
        btnMod = new JButton("%");
        btnMod.setBounds(x[2], y[1], B_WIDTH, B_HEIGHT);
		...
		//set divide button
        btnDiv = new JButton("/");
        btnDiv.setBounds(x[3], y[1], B_WIDTH, B_HEIGHT);
		...
		//set 7 button
        btn7 = new JButton("7");
        btn7.setBounds(x[0], y[2], B_WIDTH, B_HEIGHT);
		...
		//set 8 button
        btn8 = new JButton("8");
        btn8.setBounds(x[1], y[2], B_WIDTH, B_HEIGHT);
		...
		//set 9 button
        btn9 = new JButton("9");
        btn9.setBounds(x[2], y[2], B_WIDTH, B_HEIGHT);
		...
		//set multiply button
        btnMul = new JButton("*");
        btnMul.setBounds(x[3], y[2], B_WIDTH, B_HEIGHT);
		...
		//set 4 button
        btn4 = new JButton("4");
        btn4.setBounds(x[0], y[3], B_WIDTH, B_HEIGHT);
		...
		//set 5 button
        btn5 = new JButton("5");
        btn5.setBounds(x[1], y[3], B_WIDTH, B_HEIGHT);
		...
		//set 0 button
        btn6 = new JButton("6");
        btn6.setBounds(x[2], y[3], B_WIDTH, B_HEIGHT);
		...
		//set minus button
        btnSub = new JButton("-");
        btnSub.setBounds(x[3], y[3], B_WIDTH, B_HEIGHT);
		...
		//set 1 button
        btn1 = new JButton("1");
        btn1.setBounds(x[0], y[4], B_WIDTH, B_HEIGHT);
		...
		//set 2 button
        btn2 = new JButton("2");
        btn2.setBounds(x[1], y[4], B_WIDTH, B_HEIGHT);
		...
		//set 3 button
        btn3 = new JButton("3");
        btn3.setBounds(x[2], y[4], B_WIDTH, B_HEIGHT);
		...
		//set plus button
        btnAdd = new JButton("+");
        btnAdd.setBounds(x[3], y[4], B_WIDTH, B_HEIGHT);
		...
		//set dot button for float number
        btnPoint = new JButton(".");
        btnPoint.setBounds(x[0], y[5], B_WIDTH, B_HEIGHT);
		...
		//set 0 button
        btn0 = new JButton("0");
        btn0.setBounds(x[1], y[5], B_WIDTH, B_HEIGHT);
        ...
        btnEqual.setBounds(x[2], y[5], 2 * B_WIDTH + 10, B_HEIGHT);
		...
		//set square root button
        btnRoot = new JButton("√");
        btnRoot.setBounds(x[4], y[1], B_WIDTH, B_HEIGHT);
		...
		//set power button
        btnPower = new JButton("x\u207f");
        btnPower.setBounds(x[4], y[2], B_WIDTH, B_HEIGHT);
        ...
        btnLog.setBounds(x[4], y[3], B_WIDTH, B_HEIGHT);
		...
		//remove java logo with a blank logo
		//change the image path to be your image path
	...
	//function to toggle extra button for scientific mode
    private void onShowScientificMode() {
        if (isScientificMode) {
            ...
            window.setSize(JFRAME_WIDTH + 80, JFRAME_HEIGHT);
